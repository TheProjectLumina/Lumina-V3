    ...
    public static class ToolsManager
    {
        ...
        public static async Task SaveProfile()
        {
            ...
            if (result == true)
            {
                ...
                string newFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Lumina Launcher", "Profiles", editWindow.NewName);
                ...
                if (Directory.Exists(currentFolderPath))
                {
                    ...
                    if (Directory.Exists(newFolderPath))
                    {
                        ...
                        newFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Lumina Launcher", "Profiles", modifiedNewName);
                    }
        ...
        private static string GetUniqueFolderName(string folderName)
        {
            ...
            while (Directory.Exists(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Lumina Launcher", "Profiles", modifiedName)))
            {
        ...
        public static async Task ApplyProfile()
        {
            ...
            string rootFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Lumina Launcher", "Profiles");
